    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('saisie_par', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Depot',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.CharField(choices=[('1', 'facture'), ('2', 'bon'), ('3', 'bon de commande')], default=1, max_length=10)),
                ...
                ('montantregfour', models.DecimalField(decimal_places=2, max_digits=5)),
                ...
                ('prixHT', models.DecimalField(decimal_places=2, max_digits=5)),
                ('TVA', models.DecimalField(decimal_places=2, default=0, max_digits=5, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(1)])),
                ('timbre', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('remise', models.DecimalField(decimal_places=2, default=0, max_digits=5, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(0)])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('prix_U_achat', models.DecimalField(decimal_places=2, max_digits=5)),
                ('prix_detail', models.DecimalField(decimal_places=2, max_digits=5)),
                ('prix_vente_gros', models.DecimalField(decimal_places=2, max_digits=5)),
                ('prix_vente_revendeur', models.DecimalField(decimal_places=2, max_digits=5)),
                ('prix_vente_autre', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
                ...
                ('ancien_prix', models.DecimalField(blank=True, decimal_places=2, max_digits=5, null=True)),
            ],
        ),
        migrations.CreateModel(
            name='SellingPoint',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('qtte_achetée', models.DecimalField(decimal_places=2, max_digits=5)),
                ('qtte_retour', models.DecimalField(decimal_places=2, max_digits=5)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('TVA', models.DecimalField(decimal_places=2, default=0, max_digits=5, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(1)])),
                ('timbre', models.DecimalField(decimal_places=2, default=0, max_digits=5)),
                ('remise', models.DecimalField(decimal_places=2, default=0, max_digits=5, validators=[django.core.validators.MaxValueValidator(100), django.core.validators.MinValueValidator(1)])),
                ('caisse', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.caisse')),
                ('client', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.client')),
                ('depot', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='core.depot')),
