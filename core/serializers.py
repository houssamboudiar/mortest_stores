...
from .models import (Fournisseur, PayementClient, ProduitAchatCommandeFournisseur, SellingPoint, Caisse, Produit, Depot, FicheCredit, FicheDebit, Vendeur, FamilleProduit, MarqueProduit)
from . import models
